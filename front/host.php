...
Session::checkRight('siemevent', READ);
Html::header(PluginSiemHost::getTypeName(Session::getPluralNumber()), $_SERVER['PHP_SELF'], 'tools', 'pluginsiemevent');
Search::show('PluginSiemHost');
Html::footer();