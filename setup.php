...
define('PLUGIN_SIEM_MIN_GLPI', '9.4.0');
define('PLUGIN_SIEM_MAX_GLPI', '9.5.0');

function plugin_init_siem() {
    global $PLUGIN_HOOKS;
    $PLUGIN_HOOKS['csrf_compliant']['siem'] = true;
    $PLUGIN_HOOKS['add_css']['siem'] = 'css/siem.scss';
    $PLUGIN_HOOKS['add_js']['siem'] = 'js/siem.js';
    Plugin::registerClass('PluginSiemProfile', ['addtabon' => ['Profile']]);
    if (Session::haveRight('plugin_siem_host', READ)) {
        $PLUGIN_HOOKS['menu_toadd']['siem'] = ['management' => 'PluginSiemMenu'];
    }
}
